...
- [ ] **Multi-Day Processing:** Upgrade the `scripts/build_headless_movie.py` entrypoint to accept a range of dates (or automatically process all available media dates) in a single run.
